...
(function() {
			...
			on: function(b, d, g, h, k) {
				...
				if(0 > f.getListenerIndex(d)) {
					...
					for(var w = f.length - 1; 0 <= w; w--)
						if(f[w].priority <= k) return f.splice(w + 1, 0, n), {
							removeListener: q
						};
					f.unshift(n)
				}
					...
					if(f) {
						...
						if(w.length)
							for(var w = w.slice(0), A, G = 0; G < w.length; G++) {
								if(f.errorProof) try {
									A =
										w[G].call(this, q, n, b, h)
								} catch(x) {} else A = w[G].call(this, q, n, b, h);
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			enableHtml5Elements: function(a,
				f) {
				for(var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), c = b.length, k; c--;) k = a.createElement(b[c]), f && a.appendChild(k)
			},
			...
			getMouseButton: function(a) {
				var b = (a = a.data) && a.$;
				return a && b ? CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? 4 ===
					b.button ? CKEDITOR.MOUSE_BUTTON_MIDDLE : 1 === b.button ? CKEDITOR.MOUSE_BUTTON_LEFT : CKEDITOR.MOUSE_BUTTON_RIGHT : b.button : !1
			},
			style: {
				parse: {
					_colors: {
					...
					background: function(a) {
						...
						if(a = CKEDITOR.tools.trim(a)) b.unprocessed =
							a;
						return b
					},
					margin: function(a) {
			...
			array: {
				...
				map: function(a, b, c) {
					for(var k = [], d = 0; d < a.length; d++) k.push(b.call(c, a[d], d, a));
					return k
				},
	...
	(function() {
		function a(a, b) {
			...
			if(a && !this._.guardRTL) {
				...
				this._.guardRTL = function(a, b) {
					return(!b || !u.equals(a)) && (!y || !a.equals(y)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			...
			this.current ? f = this.current[J](!1, r, g) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
				(f = 0 < D ? f.getChild(D - 1) : !1 === g(f, !0) ? null : f.getPreviousSourceNode(!0, r, g)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, r, g)))), f && !1 === g(f) && (f = null));
			for(; f && !this._.end;) {
				this.current = f;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b =
					q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(D) && f(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, e) {
			function g(a, b, c, f) {
				...
				if(f && h) return X;
				l || f ? b.append(a.clone(!0, e), c) : (a.remove(), q && b.append(a, c));
				return X
			}
			...
			function k() {
				var b = C - 1,
					c = v && B && !r.equals(J);
				b < t - 1 || b < F - 1 || c ? (c ? a.moveToPosition(J,
			...
			var r = a.startContainer,
				...
				E = a.endOffset,
				u, y, v, B, L, n;
			if(l && J.type == CKEDITOR.NODE_TEXT && (r.equals(J) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(J))) c.append(a.document.createText(J.substring(H, E)));
			else {
				...
				r.type == CKEDITOR.NODE_TEXT ? l ? L = !0 : r.split(H) : 0 < r.getChildCount() ? 0 === H ? (r = r.getChild(H), u = !0) : r = r.getChild(H - 1) : v = u = !0;
				for(var O = r.getParents(), p = J.getParents(), C = m(),
						t = O.length - 1, F = p.length - 1, N = c, X, Y, U, ea = -1, P = C; P <= t; P++) {
					Y = O[P];
					U = Y.getNext();
					for(P != t || Y.equals(p[P]) && t < F ? b && (X = N.append(Y.clone(0, e))) : u ? g(Y, N, !1, v) : L && N.append(a.document.createText(Y.substring(H))); U;) {
						if(U.equals(p[P])) {
							ea = P;
							break
						}
				...
				for(P = C; P <= F; P++)
					if(c = p[P], U = c.getPrevious(), c.equals(O[P])) b && (N = N.getChild(0));
						...
						P != F || c.equals(O[P]) && F < t ? b && (X = N.append(c.clone(0, e))) : y ? g(c, N, !1, B) : n && N.append(a.document.createText(c.substring(0, E)));
						if(P > ea)
							for(; U;) U = g(U, N, !0);
						N = X
					}
		...
		CKEDITOR.dom.range.prototype = {
			...
			getBoundaryNodes: function() {
				...
				if(b.type == CKEDITOR.NODE_ELEMENT)
					if(e = b.getChildCount(),
						e > d) b = b.getChild(d).getPreviousSourceNode(!0);
			...
			enlarge: function(a, b) {
				...
				switch(a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						E.type == CKEDITOR.NODE_TEXT ? (y && (E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E, H = !!E), E && ((r = E.getPrevious()) || (l = E.getParent()))) : (y && (r = E.getChild(y - 1) || E.getLast()),
							r || (l = E));
						for(l = c(l); l || r;) {
							if(l && !r) {
								!J && l.equals(m) && (J = !0);
							...
							for(; r;)
								if(E = !1, r.type == CKEDITOR.NODE_COMMENT) r = r.getPrevious();
									...
									if(r.type == CKEDITOR.NODE_TEXT) u = r.getText(), d.test(u) && (r = null), E = /[\s\ufeff]$/.test(u);
										...
										if(H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
											...
											if(d.test(u)) r = null;
												...
												for(var y = r.$.getElementsByTagName("*"), v = 0, B; B = y[v++];)
						...
						l = r = null;
						J = H = !1;
						E.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(E.substring(y)).length ? H = !0 : (H = !E.getLength(), y == E.getLength() ? (r = E.getNext()) ||
							(l = E.getParent()) : g(E, y) && (l = E.getParent())) : (r = E.getChild(y)) || (l = E);
						for(; l || r;) {
							if(l && !r) {
								!J && l.equals(m) && (J = !0);
								if(e ? l.isBlockBoundary() : !k.contains(l)) break;
								H && "inline" == l.getComputedStyle("display") || (H = !1, J ? q = l : l && this.setEndAfter(l));
								r = l.getNext()
							}
							for(; r;) {
								E = !1;
								if(r.type == CKEDITOR.NODE_TEXT) u = r.getText(), g(r, 0) || (r = null), E = /^[\s\ufeff]/.test(u);
									...
									if((0 < r.$.offsetWidth || b && r.is("br")) && !r.data("cke-bookmark"))
										if(H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
											...
											if(d.test(u)) r = null;
												...
												for(y = r.$.getElementsByTagName("*"), v = 0; B = y[v++];)
													if(!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
														r = null;
														break
													}
						...
						h && q && (m = h.contains(q) ? q : h, this.setStartBefore(m), this.setEndAfter(m));
						break;
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						var L, n, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
								br: 1
							} : null),
							p = null,
							C = function(a) {
			...
			shrink: function(a, b, c) {
				...
				if(!this.collapsed) {
					...
					k && k.type == CKEDITOR.NODE_TEXT && (q ? q >= k.getLength() ? g.setEndAfter(k) : (g.setEndAfter(k), l = 0) : g.setEndBefore(k));
			...
			_find: function(a, b) {
				...
				if(c && c.find)
					for(m = c.find(a), g = 0; g < m.count(); g++)
						if(c = m.getItem(g), b || !c.isReadOnly()) k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), h = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
	...
	(function() {
		...
		function b(a, c, e, g) {
			...
			if((k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !k.check(c)) return b(a,
				c, e, g.remaining);c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = k;a._.nestedEditable = {
				element: g.element,
				container: e,
		...
		a.prototype = {
			getNextParagraph: function(a) {
				...
				for(this._.nextNode = null; m;) {
					...
					if(I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0);
						...
						if(CKEDITOR.dtd.$block[r] && "false" == m.getAttribute("contenteditable")) {
							...
							b(this, a, d);
							break
						} else if(m.isBlockBoundary(this.forceBrBreak && !z && {
								br: 1
							})) {
							if("br" == r) I = 1;
							...
							h && (h.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != r && (this._.nextNode = m));
							K = 1
						} else {
							if(m.getFirst()) {
					...
					if(h && !K)
						for(; !m.getNext(k) && !w;) {
							r = m.getParent();
							if(r.isBlockBoundary(this.forceBrBreak && !z && {
									br: 1
								})) {
								K = 1;
								I = 0;
				...
				G && (A = d.getLast()) && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() && (!CKEDITOR.env.needsBrFiller || A.getPrevious(g) || A.getNext(g)) && A.remove();
	...
	(function() {
		function a(a, b, c, d, e) {
			...
			for(f in b) {
				l = b[f];
				l = "boolean" == typeof l ? {} : "function" == typeof l ? {
					match: l
				} : v(l);
				...
				for(g in V) {
					...
					var p = t,
						...
						C = void 0;
					m ? B = !1 : m = {};
					for(C in F) "!" == C.charAt(0) && (C = C.slice(1), y.push(C), m[C] = !0, B = !1);
					for(; C = y.pop();) F[C] =
						F["!" + C], delete F["!" + C];
					p[r] = (B ? !1 : m) || null
				}
			...
			for(d = a.length; c < d; ++c) {
				...
				for(g in O) {
					...
					m = [];
					F = void 0;
					for(F in r) - 1 < F.indexOf("*") ? m.push(new RegExp("^" + F.replace(/\*/g, ".*") + "$")) : m.push(F);
					r = m;
					r.length && (t[u] = r, p = !1)
				}
				t.nothingRequired = p;
				...
				if(!0 === f.elements ||
					null === f.elements) e[l ? "unshift" : "push"](f);
				else
					...
					if(a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
						...
						if(a)
							if(!0 === a) a = !0;
								...
								for(var f = 0, l = c.length, t; f < l; ++f) t = c[f], e[t] ||
									(e[t] = a(t));
								a = !1
							}
						else a = !1;
		...
		function f(a) {
			var b, c, d, e, f = {},
				t = 1;
			for(a = B(a); b = a.match(p);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, f["$" + t++] = {
				elements: b[1],
				classes: c,
				styles: d,
				attributes: e
		...
		function A(a, b, e, f) {
			...
			if(f.doFilter) {
				a: {
					v = b.name;g = a._;a = g.allowedRules.elements[v];u = g.allowedRules.generic;v = g.disallowedRules.elements[v];g = g.disallowedRules.generic;
					p = f.skipRequired;
					var y = {
							valid: !1,
							validAttributes: {},
					...
					if(a || u) {
						...
						if(g)
							for(B = 0, C = g.length; B < C; ++B) c(g[B], b, y);
						if(a)
							for(B = 0, C = a.length; B < C; ++B) d(a[B], b, y, p);
						if(u)
							for(B = 0, C = u.length; B < C; ++B) d(u[B], b, y, p);
						a = y
					} else a = null
				}
				...
				var J = b.styleBackup,
					H, N, E = [],
					y = [],
					O = /^data-cke-/;B = !1;delete v.style;delete v["class"];delete b.classBackup;delete b.styleBackup;
				if(!a.allAttributes)
					for(H in v) C[H] || (O.test(H) ? H == (N = H.replace(/^data-cke-saved-/, "")) || C[N] || (delete v[H], B = !0) : (delete v[H], B = !0));
				...
				if(!a.allClasses ||
					a.hadInvalidClass) {
					for(H = 0; H < g.length; ++H)(a.allClasses || u[g[H]]) && y.push(g[H]);
					y.length && (v["class"] = y.sort().join(" "));
					p && y.length < p.split(/\s+/).length && (B = !0)
				} else p && (v["class"] = p);B && (l = 1);
		...
		function l(a, b, c) {
			...
			if(y.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
				...
				if("br" == b) a.previous && !I(a.previous) && (b = z(), b.insertBefore(a)), a.next && !I(a.next) && (b = z(), b.insertAfter(a)), a.replaceWithChildren();
				else {
					var d = a.children,
						e;
					b: {
					...
					if(e) a.name = b, a.attributes = {}, c.push({
						...
						e = a.parent;
						for(var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, v, u, t = d.length; 0 < t;) l = d[--t], f && (l.type == CKEDITOR.NODE_TEXT || l.type == CKEDITOR.NODE_ELEMENT && y.$inline[l.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b), v.insertAfter(a), c.push({
							check: "parent-down",
							el: v
						})), v.add(l, 0)) : (v = null, u = y[e.name] || y.span, l.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || l.type != CKEDITOR.NODE_ELEMENT || u[l.name] || c.push({
							check: "el-up",
							el: l
						}));
						a.remove()
		...
		function J(a, b) {
			...
			for(f in d)
				if("class" == f)
					for(c = d[f].split(/\s+/), t = a.classes.join("|"); v = c.pop();) {
		...
		CKEDITOR.filter = function(a) {
			...
			if(a instanceof CKEDITOR.editor) {
				...
				!0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(L[a.enterMode] + " " + L[a.shiftEnterMode],
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, d) {
				...
				if("string" == typeof b) b = f(b);
					...
					d && (d = v(d), e.classes = d["class"] ? d["class"].split(/\s+/) : null, e.requiredClasses = e.classes, delete d["class"], e.attributes = d, e.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
			...
			applyTo: function(a, b, c, d) {
				...
				for(var r; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
				for(; p = a.pop();)
					if(c = p.el, c.parent) switch(r = y[c.parent.name] || y.span, p.check) {
						case "it":
							y.$removeEmpty[c.name] && !c.children.length ? l(c, d, a) : m(c) || l(c, d, a);
							break;
						case "el-up":
							c.parent.type ==
								CKEDITOR.NODE_DOCUMENT_FRAGMENT || r[c.name] || l(c, d, a);
							break;
						case "parent-down":
							c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || r[c.name] || l(c.parent, d, a)
					}
				return u
			},
				...
				if(!this.disabled && a) {
					...
					for(e = 0; e < a.length; ++e) {
						...
						var f = void 0,
							...
							p = void 0;
						c = [];
						for(l = 0; l < b.length; ++l) t = b[l], "string" == typeof t ? (t = t.split(/\s*:\s*/), v = t[0], g = null, p = t[1]) : (v = t.check, g = t.left, p = t.right), f || (f = t, f = f.element ? f.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
							f.left.getDefinition().element), g instanceof CKEDITOR.style && (g = E(g)), c.push({
							check: v == f ? null : v,
							left: g,
			...
			check: function(a, b, c) {
				...
				if("string" == typeof a) {
					...
					e = d
				} else d = a.getDefinition(), e = d.styles, t = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = v(e), t.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = {
					name: d.element,
					attributes: t,
				...
				b = 0 < u.length ? !1 : CKEDITOR.tools.objectCompare(e.attributes, t.attributes, !0) ? !0 : !1;
		...
		N = CKEDITOR.filter.transformationsTools = {
			...
			transform: function(a, b) {
				if("string" == typeof b) a.name = b;
					...
					for(f in e)
						if("class" == f)
							for(c = a.classes.join("|"), l = e[f].split(/\s+/); v = l.pop();) - 1 == c.indexOf(v) && a.classes.push(v);
				...
				h = function(b) {
					a.call(this, b, function(a) {
						...
						for(f in a) {
							...
							if(!d[f]) {
								if(k.icons)
									for(var A = k.icons.split(","), G = A.length; G--;) CKEDITOR.skin.addIcon(A[G], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + A[G] + ".png");
								d[f] = 1
							}
							if(w)
		...
		function D(a) {
			...
			CKEDITOR.plugins.load(c.split(","), function(c) {
				...
				for(var l in c) {
					...
					if(O && (p = O.match(g)))
						for(; O = p.pop();) CKEDITOR.error("editor-plugin-required", {
							plugin: O.replace(",", ""),
							requiredBy: l
						});
					k && !a.lang[l] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""), h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, h) ? h : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), r.langEntries && r.langEntries[h] ? (a.lang[l] = r.langEntries[h], h = null) : f.push(CKEDITOR.getUrl(r.path + "lang/" + h + ".js")));
					e.push(h);
					d.push(r)
				}
			...
			for(var e = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
				...
				c(u) ? (f ||
					(f = y.getAscendant("table").clone(), f.append(y.getAscendant({
						...
						tbody: 1,
						tfoot: 1
					}).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(y) || (g = y, k = y.clone(), f.append(k)), k.append(d(u))) : e.append(u.cloneContents())
			}
		...
		CKEDITOR.htmlParser.fragment.fromHtml =
			function(g, h, k) {
				function n(a) {
					...
					if(0 < m.length)
						for(var c = 0; c < m.length; c++) {
							...
							l && !l[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == z.name && (D(z, z.parent, 1), c--) : (b || (q(), b = 1), d = d.clone(), d.parent = z, z = d, m.splice(c, 1), c--)
						}
				}
				...
				function D(b, c, d) {
					c = c || z || x;
					var e = z;
					void 0 === b.previous && (w(c, b) && (z = c, G.onTagOpen(k, {}), b.returnPoint = c = z), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (l = !1), "textarea" == b.name && (I = !1));
				...
				G.onTagOpen = function(e, f, g, k) {
					...
					if(a(f)) m.push(f);
						...
						if("br" == e) K.push(f);
							...
							for(; !(k = (g = z.name) ? CKEDITOR.dtd[g] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || z.isUnknown || k[e]);)
								if(z.isOptionalClose) G.onTagClose(g);
								else if(e in b && g in b) g = z.children, (g = g[g.length - 1]) && "li" == g.name || D(g = new CKEDITOR.htmlParser.element("li"), z), !f.returnPoint && (f.returnPoint = z), z = g;
							else if(e in CKEDITOR.dtd.$listItem &&
								!A(e, g)) G.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
							else if(g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = z), z = z.parent;
							else if(g in CKEDITOR.dtd.$inline && m.unshift(z), z.parent) D(z, z.parent, 1);
							else {
								f.isOrphan = 1;
								break
							}
		...
		a.prototype = {
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					n, q, f, D;
				for(D = 0; D < k; D++)
					if(d && (n = c.type, q = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
	...
	(function() {
				...
				return function(e) {
					if(e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var t = [],
							...
							v, p;
						if(l)
							for(u(l, 1) && t.push(l); l;) g(l) && (v = c(l)) && u(v) && ((p = c(v)) && !g(p) ? t.push(v) : (f(y).insertAfter(v), v.remove())), l = l.previous;
						for(l = 0; l < t.length; l++) t[l].remove();
						if(t = !a || !1 !== ("function" == typeof d ? d(e) : d)) y || CKEDITOR.env.needsBrFiller ||
							e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (t = b(e), t = !t || "form" == e.name && "input" == t.name) : t = !1 : t = !1;
						t && e.add(f(a))
					}
				}
			}
					...
					if(b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
							...
							for(d = b.next; d && e(d);) d =
								d.next;
							var t = c(b);
							!d && g(b.parent) ? h(b.parent, f(a)) : g(d) && t && !g(t) && f(a).insertBefore(d)
						}
					}
				}
			}(y);
		...
		var m = /(?:&nbsp;|\xa0)$/,
			...
			l = CKEDITOR.tools.extend({}, z.$blockLimit,
				z.$block),
			r = {
				elements: {
					input: k,
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				for(n in h) {
					...
					q && (!1 === (k = a.onAttribute(b, d, q, k)) ? delete h[q] :
						h[q] = k)
				}
		...
		CKEDITOR.editor.prototype.setMode = function(a, b) {
			...
			if(a != d.mode && h && h[a]) {
				...
				if(d.mode) {
					...
					"source" == d.mode && h == n && (d.fire("lockSnapshot", {
						forceUpdate: !0
					}), q = 1);
	...
	(function() {
		function a(a) {
			...
			h(b, e.block, f) && u.collapsed && !u.getCommonAncestor().isReadOnly() && (e = u.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) {
					return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
				}, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
				(b = u.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), y = 1, a.cancel());
			y && u.select()
		}
		...
		function g(a) {
			...
			if(e.startPath().contains(f)) {
				...
				a.guard = b();
				a.checkBackward();
				if(d) return u = e.clone(), u.collapse(), u.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(u), a.guard = b(!0), d = !1, a.checkForward(), d
			}
			return null
		}
			...
			proto: {
				...
				setup: function() {
					...
					this.attachListener(a, "beforeGetData", function() {
						var b = this.getData();
						this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(G, function(a, b) {
							return b
						}));
						a.setData(b, null, 1)
					}, this);
					...
					if(!this.is("textarea")) {
						...
						if(h) {
							...
							u ? h != u.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? u.$.styleSheet.cssText = h : u.setText(h)) : (h = e.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), k.setCustomData("stylesheet",
								h), h.data("cke-temp", 1))
						}
						...
						CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function(b) {
							if(2 == b.data.$.button && (b = b.data.getTarget(), !b.getOuterHtml().replace(G, ""))) {
								var c = a.createRange();
		...
		x = function() {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for(var k = v[k.getName()], h = 0, B = c.getChildren(), n = B.count(), L = -1, q = -1, E = 0, H = e.contains(v.$list); h < n; ++h) e = B.getItem(h), a(e) ? (u = e.getName(), H && u in CKEDITOR.dtd.$list ? y = y.concat(b(e, d)) : (g = !!k[u],
					"br" != u || !e.data("cke-eol") || h && h != n - 1 || (E = (f = h ? y[h - 1].node : B.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && v.$block[f.getName()]), -1 != L || g || (L = h), g || (q = h), y.push({
						isElement: 1,
						isLineBreak: E,
					...
					node: e,
					allowed: 1
				}); - 1 < L && (y[L].firstNotAllowed = 1); - 1 < q && (y[q].lastNotAllowed = 1);
				return y
			}
			...
			return function(B, p, C, t) {
				...
				if(!t.checkReadOnly()) {
					...
					if(!p.collapsed) {
						...
						F && !F.equals(x) && !F.contains(x) && p.checkEndOfBlock() && B.zombies.push(F);
						p.deleteContents()
					}
					for(;
					...
					m = p.startPath();
					if(F = m.contains(f, !1, 1)) p.splitElement(F),
						B.inlineStylesRoot = F, B.inlineStylesPeak = m.lastElement;
					m = p.createBookmark();
					(F = m.startNode.getPrevious(c)) && a(F) && f(F) && t.push(F);
					(F = m.startNode.getNext(c)) && a(F) && f(F) && t.push(F);
					for(F = m.startNode;
						(F = F.getParent()) && f(F);) t.push(F);
					p.moveToBookmark(m);
					if(m = C) {
						m = B.range;
					...
					if(m) {
						...
						for(g(p, A); t < p.length; t++) {
							...
							if(M = q.isLineBreak) {
								...
								var R = void 0,
									Z = void 0;
								q.hasBlockSibling ? M = 1 : (R = M.startContainer.getAscendant(v.$block, 1)) && R.is({
									div: 1,
									p: 1
								}) ? (Z = R.getPosition(I), Z == CKEDITOR.POSITION_IDENTICAL || Z == CKEDITOR.POSITION_CONTAINS ? M = 0 : (I = M.splitElement(R), M.moveToPosition(I, CKEDITOR.POSITION_AFTER_START), M = 1)) : M = 0
							}
							if(M) C = 0 < t;
							else {
								M = A.startPath();
								!q.isBlock && h(B.editor, M.block, M.blockLimit) && (S = k(B.editor)) && (S = m.createElement(S), S.appendBogus(), A.insertNode(S),
									CKEDITOR.env.needsBrFiller && (z = S.getBogus()) && z.remove(), A.moveToPosition(S, CKEDITOR.POSITION_BEFORE_END));
								...
								if(F && q.isElement) {
									...
									if(M) I && (K = A.splitElement(I), B.zombies.push(K), B.zombies.push(I));
									else {
										I = w.getName();
										W = !t;
										M = t == p.length - 1;
										I = d(q.node, I);
										for(var R = [], Z = I.length, aa = 0, ca = void 0,
												da = 0, T = -1; aa < Z; aa++) ca = I[aa], " " == ca ? (da || W && !aa || (R.push(new CKEDITOR.dom.text(" ")), T = R.length), da = 1) : (R.push(ca), da = 0);
										M && T == R.length && R.pop();
										W = R
									}
								}
								...
								q.lastNotAllowed && t < p.length - 1 && ((K = x ? N : K) && A.setEndAt(K, CKEDITOR.POSITION_AFTER_START), F = 0);
								A.collapse()
							}
						}
					...
					for(W = z.createBookmark(); G = B.zombies.pop();) G.getParent() && (S = z.clone(), S.moveToElementEditStart(G), S.removeEmptyBlocksAtEnd());
					if(K)
						for(; G = K.pop();) CKEDITOR.env.needsBrFiller ? G.appendBogus() : G.append(z.document.createText(" "));
					for(; G = B.mergeCandidates.pop();) G.mergeSiblings();
					z.moveToBookmark(W);
					if(!B.dontMoveCaret) {
						for(G = e(z); G && a(G) && !G.is(v.$empty);) {
							if(G.isBlockBoundary()) z.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
							else {
					...
					function a(c) {
						...
						g.guard = function(a, g) {
							...
							if(g && k && a.equals(k)) f = c.clone(), f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), e.push(f);
								...
								if(F = !g) F = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h ||
									b(a, h));
	...
	(function() {
		function a(a, b) {
			...
			if((c = !b && 1 === a.length) && !(c = a[0].collapsed)) {
				...
				var f = e.endContainer.getAscendant({
					td: 1,
					th: 1
				}, !0);
		...
		var x = "function" != typeof window.getSelection,
			...
			z = new RegExp(K + "( )?", "g"),
			I, l, r, J = CKEDITOR.dom.walker.invisible(1),
			H = function() {
				function a(b) {
					return function(a) {
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				if(CKEDITOR.env.ie || l) x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
					c.lockSelection(q);
					y = 1
				...
				if(CKEDITOR.env.ie && !l) {
					...
					h.attachListener(h, "mousedown", function(a) {
						2 ==
							a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (n = c.window.getScrollPosition()))
					});
					...
					if("BackCompat" != k.$.compatMode) {
						if(CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
							...
							u.on("mousedown", function(a) {
								...
								a = a.data;
								if(a.getTarget().is("html") && a.$.y < u.$.clientHeight && a.$.x < u.$.clientWidth) {
									m = t.$.createTextRange();
									try {
				...
				var a = x ? function() {
					...
					var b = function(b, c) {
						...
						for(var e = d.children, f, g, h = b.duplicate(), k = 0,
								l = e.length - 1, u = -1, q, n; k <= l;)
							if(u = Math.floor((k + l) / 2), f = e[u], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = u - 1;
							else if(0 > q) k = u + 1;
						else return {
							container: d,
							offset: a(f)
						...
						for(; 0 < h;) try {
							g = f[0 < q ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, n = g), f = g
						} catch(m) {
							return {
								container: d,
								offset: a(f)
			...
			selectRanges: function(b) {
				...
				if(b.length)
					if(this.isLocked) {
						...
						if(l) this.fake(l);
						else if(d && d.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && a(b) && !I) c.call(this, b);
						else {
							if(x) {
								...
								k ? (l = d.document.$.body.createTextRange(), l.moveToElementText(k.$), m.setEndPoint("EndToEnd", l), m.moveEnd("character", -1)) : (t = C.getNext(p), F = C.hasAscendant("pre"), t = !(t && t.getText && t.getText().match(l)) &&
									(F || !C.hasPrevious() || C.getPrevious().is && C.getPrevious().is("br")), F = d.document.createElement("span"), F.setHtml("\x26#65279;"), F.insertBefore(C), t && d.document.createText("﻿").insertBefore(C));
								d.setStartBefore(C);
								C.remove();
								b ? (t ? (m.moveStart("character", -1), m.select(), d.document.$.selection.clear()) : m.select(), d.moveToPosition(F, CKEDITOR.POSITION_BEFORE_START), F.remove()) : (d.setEndBefore(k), k.remove(), m.select())
							} else {
								k = this.getNative();
								if(!k) return;
								...
								for(m = 0; m < b.length; m++) {
									if(m <
										b.length - 1 && (t = b[m], F = b[m + 1], l = t.clone(), l.setStart(t.endContainer, t.endOffset), l.setEnd(F.startContainer, F.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), d = l.getCommonAncestor(), l = l.getEnclosedNode(), d.isReadOnly() || l && l.isReadOnly()))) {
									...
									try {
										...
										if(0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), F.setEnd(d.endContainer.$, d.endOffset);
										else throw r;
									}
									k.addRange(F)
								}
	...
	(function() {
				...
				for(r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					...
					if(r.equals(u)) r = null, l = !0;
						...
						if(x && m && CKEDITOR.dtd.$block[A])
							for(var z = r, y = e(z), E = void 0, H = y.length, I = 0, z = H && new CKEDITOR.dom.range(z.getDocument()); I < H; ++I) {
								var E = y[I],
						...
						if(y)
							if(E = r.getParent(), y = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E)) l = !0;
							else {
								if(v ||
					...
					if(l && v && !v.collapsed) {
						for(var l = K(this, f), x = l.hasAttributes(), D = v.getCommonAncestor(), A = {}, y = {}, E = {}, H = {}, T, Q, ba; l && D;) {
							if(D.getName() == g) {
								for(T in h.attributes) !H[T] && (ba = D.getAttribute(Q)) &&
									(l.getAttribute(T) == ba ? y[T] = 1 : H[T] = 1);
								for(Q in h.styles) !E[Q] && (ba = D.getStyle(Q)) && (l.getStyle(Q) == ba ? A[Q] = 1 : E[Q] = 1)
							}
							D = D.getParent()
						}
						...
						l ? (v.extractContents().appendTo(l), v.insertNode(l), G.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), v.extractContents().appendTo(l), v.insertNode(l), G.call(this, l), l.remove(!0));
						v = null
					}
				}
				c.moveToBookmark(n);
		...
		CKEDITOR.style = function(a, b) {
			...
			c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
				a.element : "*";
			this.type = a.type || (E[c] ? CKEDITOR.STYLE_BLOCK : u[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
			...
			checkElementMatch: function(a, b) {
				...
				if("string" == typeof this.element ?
					...
					if(c._length) {
						for(var h in c)
							if("_length" != h)
								if(d = a.getAttribute(h) || "", "style" == h ? J(c[h], d) : c[h] == d) {
									if(!b) return !0
								} else if(b) return !1;
						if(b) return !0
					} else return !0
		...
		CKEDITOR.dom.elementPath = function(b, e) {
			...
			do
				if(n.type == CKEDITOR.NODE_ELEMENT) {
					...
					if(n.equals(e)) break;
					if(!h && (q = n.getName(),
							"true" == n.getAttribute("contenteditable") ? h = n : !g && d[q] && (g = n), a[q])) {
						if(q = !g && "div" == q) {
							a: {
								q = n.getChildren();
	...
	*/
				...
				a.on("paste", function(d) {
					...
					if(g && (c || h) && (!1 !== a.fire("pasteFromWord", e) || c)) {
						...
						var k =
							l(a, f, function() {
								if(k) a.fire("paste", b);
								else if(!a.config.pasteFromWordPromptCleanup || c || confirm(a.lang.pastefromword.confirmCleanup)) e.dataValue = CKEDITOR.cleanWord(e.dataValue, a), a.fire("afterPasteFromWord", e), b.dataValue = e.dataValue;
								c = 0
							});
						k && d.cancel()
					}
	...
	(function() {
		...
		function u(d, f) {
			for(var b = D(d) ? d : q(d),
					c = b[0].getAscendant("table"), e = w(b, 1), b = w(b), a = f ? e : b, g = CKEDITOR.tools.buildTableMap(c), c = [], e = [], b = [], k = g.length, h = 0; h < k; h++) c.push(g[h][a]), e.push(f ? g[h][a - 1] : g[h][a + 1]);
		...
		function y(d) {
			...
			l.length ==
				d && (b[0].moveToPosition(c, CKEDITOR.POSITION_AFTER_END), b[0].select(), c.remove());
			return k
		}
		...
		function z(d) {
			if(d instanceof CKEDITOR.dom.selection) {
				...
				a: {
					...
					for(a = 0; k = b[a++];)
						if((h = k.getPrevious()) &&
							!h.getCustomData("delete_cell") || (h = k.getNext()) && !h.getCustomData("delete_cell")) {
		...
		function C(d, f) {
			...
			if(1 < h) {
				l = Math.ceil(h / 2);
				for(var h =
						Math.floor(h / 2), c = g + l, e = new CKEDITOR.dom.element(e.$.rows[c]), a = A(a, c), m, c = b.clone(), g = 0; g < a.length; g++)
	...
	(function() {
		function x(a, b) {
			...
			f > p && (c = f, f = p, p = c);
			for(c = h; c <= m; c++)
				for(h = f; h <= p; h++) d = new CKEDITOR.dom.element(e[c][h]), d.$ && !d.getCustomData("selected_cell") && (l.push(d), CKEDITOR.dom.element.setMarker(k,
					d, "selected_cell", !0));
			CKEDITOR.dom.element.clearAllMarkers(k);
			return l
		}
		...
		function v(a) {
			function b(a, b) {
				return a && b ? a.equals(b) || a.contains(b) ||
					b.contains(a) || a.getCommonAncestor(b).is(f) : !1
			}
			...
			if(a.data.getTarget().getName) {
				...
				(k || l) && J(e, k || l, a);
				"mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && (c(a.data.getTarget()) || b(m, l)) && I(e), g = {
					active: !1
		...
		function L(a) {
			...
			b && !b.hasClass("cke_table-faked-selection") &&
		...
		function M(a, b) {
			...
			var d = a.getSelection(),
				...
				p, r, B, g;
			h.getById("cke_table_copybin") || (p = h.createElement(f), r = h.createElement(f), r.setAttributes({
				...
				a.config.contentsLangDirection ? "left" : "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), r.append(p), a.editable().append(r), g = a.on("selectionChange", c, null, null, 0), k && (B = l.scrollTop), m.selectNodeContents(p), m.select(), k && (l.scrollTop = B), setTimeout(function() {
				r.remove();
				d.selectBookmarks(e);
				g.removeListener();
				a.fire("unlockSnapshot");
		...
		function C(a) {
			...
			b.getSelection().isInTable() && M(b, "cut" ===
				a.name)
		}
		...
		q.prototype.getTableMap = function() {
			...
			return CKEDITOR.tools.buildTableMap(this._getTable(),
				n(this.rows.first), a, n(this.rows.last), b)
		};
		...
		q.prototype.insertRow = function(a, b, c) {
			...
			for(var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, h = c ? [] : this.cells.all, m, l = 0; l < a; l++) m = D(c ? this.cells.all : h, b), m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(), function(a) {
		...
		q.prototype.insertColumn = function(a) {
			...
			for(var c = this.cells, d = c.all, e = n(c.first), h = n(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(E(d), b));
		...
		var F = {
			onPaste: function(a) {
				...
				var d = a.editor,
					...
					k, f;
				!h.length || 1 === h.length && !G(e.getRanges()[0]) && !l || l && !m || (h = h[0].getAscendant("table"), k = new q(u(e, h)), d.once("afterPaste", function() {
					var a;
					if(f) {
				...
				for(f = 0; f < c.length; f++)
					for(l = new CKEDITOR.dom.element(h.$.rows[a.rows.first.$.rowIndex + f]), p = 0; p < c[f].length; p++)
						if(k = new CKEDITOR.dom.element(c[f][p]), d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null, k && !k.getCustomData("processed")) {
							...
							else if(0 === p || c[f][p - 1])(d = 0 !== p ? new CKEDITOR.dom.element(c[f][p - 1]) : null) && l.equals(d.getParent()) ? k.insertAfter(d) : 0 < e ? l.$.cells[e] ? k.insertAfter(new CKEDITOR.dom.element(l.$.cells[e])) : l.append(k) :
								l.append(k, !0);
				...
				c.attachListener(c, "keydown", function(a) {
					...
					return function(l) {
						...
						if(h[k] && (f = a.getSelection()) && f.isInTable() && f.isFake)
							if(g = f.getRanges(), n = g[0]._getTableElement(), q = g[g.length -
									1]._getTableElement(), l.data.preventDefault(), l.cancel(), 8 < k && 46 > k) g[0].moveToElementEditablePosition(m ? n : q, !m), f.selectRanges([g[0]]);
							else {
				...
				CKEDITOR.plugins.tableselection.isSupportedEnvironment &&
					(a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom", function() {
						...
						CKEDITOR.plugins.clipboard && !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported && (b.attachListener(b,
							"cut", C), b.attachListener(b, "copy", C))
					}), a.on("paste", F.onPaste, F), z(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function(a, c) {
						t(a, c.selectedCells)
